...
BUILD 075 остаётся последней опубликованной мобильной версией. BUILD 076
находится только в незакоммиченном локальном состоянии. До завершения тестов и
публикации не выдавать пользователю ссылку `?release=076` как готовую.

### Уже реализовано локально, но ещё не выпущено
