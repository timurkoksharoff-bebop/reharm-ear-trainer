...
return {PILOTS,TEACHERS,ARTIFACTS,RHYTHMS,RHYTHM_HINTS,RHYTHM_LEVELS,rhythmIds,POLYRHYTHMS,polyEvents,NUMBER_LABELS,NUMBER_OFFSETS,orderedTargets,gradeNumber,obstacleRow,touchesWall,createExpedition};
})();
const module_audio=(()=>{
