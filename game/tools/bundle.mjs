...
const names=['book-catalog','music','intervals','combat','melodies-catalog','melody-levels','flight-tones','expedition','audio','i18n','assets-loader','importer','standards-catalog','standards-library','melody-library','mistake-log','debrief','game'];
