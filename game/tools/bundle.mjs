...
const names=['book-catalog','music','intervals','combat','melodies-catalog','rock-melodies','classical-melodies','melody-bank','melody-levels','flight-tones','expedition','audio','i18n','assets-loader','importer','standards-catalog','standards-library','melody-library','mistake-log','debrief','intelligence','game'];
