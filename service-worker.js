...
const APP_FILES = [
  ...
  "./game/garden-tour-routes.mjs",
  "./game/book-catalog.mjs",
  "./game/assets/echo-garden/blue-gardens.webp",
  "./game/assets/echo-garden/night-bloom.webp",
  "./game/assets/echo-garden/white-thaw.webp",
  "./game/assets/echo-garden/night-bloom-aligned.webp",
  ...
  "./game/assets/echo-garden/collectibles/crew-berries.webp",
  "./game/assets/echo-garden/collectibles/repair-lotus.webp",
  "./game/assets/echo-garden/collectibles/poison-seed.webp",
  "./game/assets/echo-garden/collectibles/crater.webp",
  "./game/assets/echo-garden/collectibles/arpeggio-flower.webp",
  "./game/assets/echo-garden/collectibles/root-flower.webp",
  "./game/assets/echo-garden/collectibles/hold-flower.webp",
  "./game/assets/echo-garden/collectibles/hold-arpeggio-flower.webp",
  "./game/assets/echo-garden/collectibles/midpoint-seed.webp",
  "./game/assets/echo-garden/samples/felt-c3.wav",
  "./game/assets/echo-garden/samples/felt-e3.wav",
  "./game/assets/echo-garden/samples/felt-g3.wav",
  "./game/assets/voices/male-basic.wav",
  "./game/assets/voices/male-guide.wav",
  "./game/assets/voices/male-all.wav",
  "./game/assets/voices/female-color.wav",
  "./",
  "./index.html",
  "./styles.css",
  "./app.js",
